...
# speed_choice="final_0125/"
# thres=0.125

def main_wutime(file_name, model_path, is_Window, tot_frm,speed_choice,thres):
...
if __name__ == '__main__':
    ...
    #     print(video_item,"start")
    #     start=time.time()
    #     time_sum+=main(config.seq_path_A1+video_item,config.model_path,config.is_Window,config.tot_frm)
    #     print(time.time()-start)
    #
